      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-28">
          {stats.map(({ icon: Icon, value, label, desc }) => (
            <div
              key={label}
              className="group relative bg-cream rounded-2xl p-7 border border-gold/10 hover:border-gold/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-gold/10 overflow-hidden"
            >
              {/* glow */}
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {reasons.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="group bg-cream rounded-2xl p-6 border border-gold/10 hover:border-gold/35 hover:shadow-lg hover:shadow-gold/8 transition-all duration-300 hover:-translate-y-0.5"
              >
